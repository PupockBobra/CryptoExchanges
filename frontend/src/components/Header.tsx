import { BarChart2, BarChart, Clock, Activity, Globe, List, Sun, Moon, Newspaper, Percent, Rocket, PieChart } from 'lucide-react'
import { formatSymbol } from '../types'

export type Page = 'dashboard' | 'instruments' | 'exchanges' | 'history' | 'analytics' | 'daily-volume' | 'news' | 'funding' | 'launches' | 'tradfi-market-share'
